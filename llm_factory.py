...
def create_llm(temperature=0.1):
    ...
    if provider == "openai":
        ...
        print(f"{Fore.GREEN}[LLM Factory] Initializing OpenAI model: gpt-4o-mini{Style.RESET_ALL}")
        ...
        print(f"{Fore.GREEN}[LLM Factory] Initializing Google Gemini model: gemini-2.5-flash{Style.RESET_ALL}")
        return init_chat_model("gemini-2.5-flash", model_provider="google_genai", temperature=temperature)
